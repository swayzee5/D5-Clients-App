...
const MODULES: Record<string, ModuleContent> = {
  regularite: {
    ...
    action:
      "Identifie tes 3 créneaux d'entraînement cette semaine et mets-les dans ton calendrier maintenant — avant de fermer cette page.",
  },
  hydratation: {
    emoji: "💧",
    ...
    action:
      "Prépare ta bouteille d'eau ce soir pour demain matin. Mets-la là où tu la verras en premier — avant ton téléphone.",
  },
  sommeil: {
    emoji: "😴",
    ...
    action:
      "Décide d'une heure de coucher ce soir et respecte-la. C'est ton action la plus importante pour ce module.",
  },
  nutrition: {
    emoji: "🥗",
    ...
    action:
      "Regarde ton dernier repas. Avait-il une source de protéines suffisante ? Si non, c'est ton premier ajustement — commence au prochain repas.",
  },
};
